...
const ArribosCamioneta = ({ data }) => {
  const arrivals = data?.arrivalCamioneta || [];
  ...
  return (
    <PageWrapper>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <StatCard label="Total Camionetas" value={arrivals.length} sub={`${totalPiezas.toLocaleString()} piezas`} />
...
export default ArribosCamioneta;
