  ...
  return (
    <div className="bg-[#111827]/20 p-6 rounded-2xl border border-white/5 h-[400px]">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h3 className="text-lg font-black text-white mb-1 tracking-tight">Pulso de Descarga</h3>
        ...
        <div className="flex gap-6 text-[9px] font-black tracking-widest">
          <span className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-sm bg-red-500 opacity-50" />
            ARRIBO
          </span>
          <span className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-sm bg-emerald-400 opacity-50" />
            BIPEO
          </span>
        </div>
      </div>
